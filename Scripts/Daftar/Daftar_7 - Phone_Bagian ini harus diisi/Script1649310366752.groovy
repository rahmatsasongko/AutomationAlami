...
WebUI.setText(findTestObject('Daftar/input_Nama Lengkap_name'), 'Nama')

WebUI.setText(findTestObject('Daftar/input_Email_email'), 'bisco1963@eonohocn.com')

WebUI.setText(findTestObject('Daftar/input_No. Handphone_phone'), '')

WebUI.setEncryptedText(findTestObject('Daftar/input_Password_password'), 
    '2a5piYK/fw3HRfXnBeyCZg==')
...
WebUI.verifyElementVisible(findTestObject('Daftar/label_Phone_Bagian ini harus diisi'))
