...
WebUI.setText(findTestObject('Daftar/input_Nama Lengkap_name'), 'Registrasi Pertamakali')

WebUI.setText(findTestObject('Daftar/input_Email_email'), 'data.rahko@gmail.com')
...
WebUI.verifyElementVisible(findTestObject('Daftar/Verify_TerimaKasih'), 
